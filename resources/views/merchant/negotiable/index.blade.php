...
<div style="display:none">
        <div>
            <form action="{{ route('vendor.negotiable.price',$negotiable->id) }}" method="post" class="form-inline">
                {{csrf_field()}}
            <ul class="liststyle--none">
                <li><span class="mr-10 bold">Negotiate Fixed Price:</span></li>
            </ul>
                <div class="form-group mx-sm-3 mb-2">
                    <input type="number" placeholder="Enter Fixed Price" value="{{ $negotiable->fixed_price }}" class="form-control" name="fixed_price">
                </div>
