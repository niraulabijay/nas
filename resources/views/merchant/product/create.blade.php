...
<style>
    ...
    <section class="content__box content__box--shadow">
        <div class="  details-of-orders">
            ...
            <a href="{{ route('vendor.products.create.new') }}">  <button class="btn btn-primary pull-right">Add New</button></a>
            <div class="clearfix"></div>
        </div>
    </section>
    <form class="uk-form-horizontal uk-margin-large" action="{{route('vendor.products.store.new')}}" method="post" enctype="multipart/form-data" style="margin-top:0px !important;">
        {{ csrf_field() }}
                                ...
                                <div role="tabpanel" class="tab-pane " id="category">
                                    ...
                                    <section>
                                        ...
                                        <div class="col-md-3" style="margin-top:10px;">
                                            <section class="add-product__form--right" style="border: 1px solid #ccccccb8;">
                                                <div class=" uk-card uk-card-default uk-card-body uk-padding-small">
                                                    <div class="title">Brand</div>
                                                    <div class="simple__box">
                                                        <div class="checkbox" style="width: 100%">
                                                            <select class="js-example-basic-multiple select2" name="brand_id" style="width: 100%">
                                                                <option value="128" @if(isset($existing) && $existing->brand_id == 128) selected @endif>Non Brand</option>
                                                                @foreach($brands as $brand)

                                                                    <option value="{{$brand->id}}" @if(isset($existing) && $existing->brand_id == $brand->id) selected @endif>{{$brand->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                    ...
                                    <section class="col-md-12 content__box uk-margin-top">
                                        <div class="product--info">
                                            <ul class="nav nav-tabs">
                                                ...
                                                <li style="display:none;"><a data-toggle="tab" href="#faqs">FAQS</a></li>
                                                <li style="display:none;"><a data-toggle="tab" href="#seo">SEO</a></li>
                                            </ul>
                                            <div class="tab-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                ...
                                                                <label class="col-sm-3 control-label" for="sku">SKU (Stock Keeping Unit)</label>
                                                                <div class="col-sm-9">
                                                                    
                                                                    <input id="sku" type="text" class="form-control" name="sku"
                                                                               placeholder="nas-abcd123">
                                                                </div>
                                                            </div>
                                                                ...
                                                                <!--    </div>-->
                                                                <!--</div>-->
                                                                <div class="form-group col-md-6 sale--inline" style="display:none;">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon" >TAX</span>
                                                                        <input id="sku" type="number" class="form-control" name="tax" placeholder="13" value="{{ isset($existing) ? $existing->tax : '' }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <table class="table table-bordered table-specifications">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th></th>
                                                                    <th>
                                                                        <button class="btn btn-success btn-sm btn-add-specification">Add New</button>
                                                                    </th>
                                                                </tr>
                                                                </tfoot>
                                                            </table>
                                                        ...
                                                        <div class="col-md-12">
                                                            <table class="table table-bordered table-features">
                                                                        ...
                                                                        <tr data-row="{{ $loop->iteration }}">
                                                                            ...
                                                                            <td>
                                                                                <button type="button"
                                                                                        ...
                                                                                        data-specification="{{ $feature->id }}"><i
                                                                                            class="fa fa-trash"></i>
                                                                                </button>
                                                                            </td>
                                                                        </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th></th>
                                                                    <th>
                                                                        <button class="btn btn-success btn-sm btn-add-feature">Add New</button>
                                                                    </th>
                                                                </tr>
                                                                </tfoot>
                                                            </table>
                                                ...
                                                <div id="seo" class="tab-pane fade">
                                                    <h3>Meta Keywords</h3>
                                                    <div class="tag--input">
                                                        <textarea value="" data-role="tagsinput" class="form-control" style="width: 100%;" name="meta_keyword"></textarea>
                                                        <h6 class="help-block">write tags and press ',' to add it</h6>
                                                    </div>
                                                    <h3>Meta Content</h3>
                                                    <div class="uk-margin">
                                                        <textarea class="uk-textarea" name="meta_description" rows="5" placeholder="textarea for meta description"></textarea>
                                                    </div>                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <section class="simple__box">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="name"
                                                       placeholder="Product title" value="{{ isset($existing) ? $existing->name : old('name') }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6 sale--inline">
                                                ...
                                                <div class="uk-form-controls">
                                                    <div class="uk-inline">
                                                        ...
                                                        <input id="msg" class="uk-input" type="number" name="product_price" value="{{ isset($existing) ? $existing->product_price :  old('product_price') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6 sale--inline">
                                                ...
                                                <div class="uk-form-controls">
                                                    <div class="uk-inline">
                                                        <span class="uk-form-icon">Rs</span>
                                                        <input id="msg" class="uk-input" type="number" name="sale_price" value="{{ isset($existing) ? $existing->sale_price :  old('sale_price') }}">
                                                    </div>
                                                </div>
                                        ...
                                        {{--<div class="row">--}}
                                            {{--<div class="uk-margin uk-grid-small uk-child-width-auto uk-grid sale--inline">--}}
                                                ...
                                                {{--</label>--}}
                                                {{--<label>--}}
                                                    {{--<input class="uk-radio" type="radio" name="negotiable" value="0" checked>Unavailable--}}
                                                {{--</label>--}}
                                            {{--</div>--}}
                                        ...
                                        <div class="title" style="display:none;">Product Quality</div>
                                        <div class="row" style="display:none;">
                                            <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid sale--inline">
                                                <label>
                                                    <input class="uk-radio" type="radio" name="quality" value="Genuine Product" checked>Genuine Product
                                                </label>
                                                <label>
                                                    <input class="uk-radio" type="radio" name="quality" value="Quality Assurence">Quality Assurence
                                                </label>
                                                <label>
                                                    <input class="uk-radio" type="radio" name="quality" value="Clone Product">Clone Product
                                                </label>
                                                <label>
                                                    <input class="uk-radio" type="radio" name="quality" value="Standard Product">Standard Product
                                                </label>
                                            </div>
                                        </div>
                                        <section class="description" style="display:none;">
                                            ...
                                            <div class="uk-margin">
                                                <textarea class="uk-textarea" name="short_description" rows="5" placeholder="textarea for privacy policy"></textarea>
                                            </div>
                                        </section>
                                        <section class="description">
                                            <div class="title">long description</div>
                                            <textarea class="longdescrip" name="long_description">{{ isset($existing) ? $existing->long_description : old('long_description') }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="color" class="form-control" value=" {{ old('color') }} " placeholder="Type your item color (e.g. white)">
                                            </div>
                                              <div class="form-group stock-qty pad-20" >
                                                                <label class="col-sm-12 control-label" for="qty">Stock Qty</label>
                                                                <div class="col-sm-12">
                                                                    <input min="1" class="form-control" name="stock_quantity" value=" {{ old('stock_quantity') }} " type="number">
                                                                </div>
                                                            </div>
                                            <table class="table table-bordered table-colors">
                                                <thead>
                                                <tr style="background: #f1f1f1;color: #000;">
                                                    <th>SN</th>
                                                    <th>Quantity</th>
                                                    <th>Size</th>
                                                    <th>Action</th>
                                                ...
                                                <tr style="color: #ccc;">
                                                    ...
                                                    <th>
                                                        <a href="javascript:void(0)"
                                                           class="btn btn-success btn-sm btn-add-color">Add New</a>
                                                    </th>
                                                </tr>
                                                </tfoot>
                                            </table>
