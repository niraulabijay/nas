                    ...
                    <div class="panel-body" style="padding: 10px;">
                        <ul class="liststyle--none" style="margin: 0;">
                            <li>
                                ...
                                <span>{{ $order->userDetails->first_name . ' ' . $order->userDetails->last_name }}</span>
                            </li>
                            <li>
                                <strong>Address:</strong>
                                <span>{{ $order->userDetails->area }}, {{ $order->userDetails->district }}, {{ $order->userDetails->zone }}</span>
                            </li>
                            <li>
                                <strong>Mobile no:</strong>
                                <span>{{ $order->userDetails->mobile }}{{ $order->userDetails->phone != null ? ',' . $order->userDetails->phone : '' }}</span>
                            </li>
                            <li>
                                <strong>Email:</strong>
